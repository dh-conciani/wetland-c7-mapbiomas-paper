...
var classIds = [
     [11],                 // native
    //[15],                // pasture
    // [36, 46, 47, 48],    // perennial crops
    // [19, 39, 20, 40, 41] // temporary crops
];
        ...
        classIds.forEach(
            function (classList) {
                ...
                Export.image.toAsset({
                    "image": trajectories.toInt8(),
                    "description": 'col7_trajectories_wetland_cerrado',
                    "assetId": 'users/dh-conciani/basemaps/col7_trajectories_wetland_cerrado',
                    "scale": 30,
                    "pyramidingPolicy": {
                        '.default': 'mode'
                    },
