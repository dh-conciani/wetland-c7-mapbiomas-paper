...
var asset = [
    root + 'col7_trajectories_wetland_cerrado',
    root + 'col7_nYearPresence_wetland_cerrado',
    root + 'col7_nChanges_wetland_cerrado',
    root + 'col7_nClasses_wetland_cerrado'
  ];
...
//var years = ee.List.sequence({'start': 2000, 'end': 2021, 'step': 1}).getInfo();
var years = ['variable'];
