...
var root = 'projects/mapbiomas-workspace/public/collection6/';

// define files to process 
var asset = [
    root + 'mapbiomas-fire-collection1-fire-frequency-1'
  ];
...
var years = ['1985_2020', '1985_2000', '2010_2020', '2000_2020'];
...
asset.map(function(file) {
  ...
  var areas = years.map(
      function (year) {
          ...
          var image = asset_i.select('fire_frequency_' + year);
